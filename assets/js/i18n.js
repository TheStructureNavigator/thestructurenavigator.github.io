    ...
    pl: {
      ...
      portfolio: {
        ...
        texts: {
          ...
          "#services .section-title h3": "Obszary, w których pracuję i rozwijam rozwiązania",
          "#services .section-title p": "To przekrój specjalizacji, w których łączę myślenie systemowe, technologię i analizę procesów, aby projektować użyteczne i skalowalne rozwiązania.",
          "#services .col-md-4:nth-child(1) h2": "Inżynieria oprogramowania i architektura systemów",
          "#services .col-md-4:nth-child(1) p": "Projektowanie i rozwój aplikacji webowych, systemów backendowych, baz danych oraz integracji, które łączą dane, narzędzia i procesy biznesowe w spójne rozwiązania cyfrowe.",
          "#services .col-md-4:nth-child(2) h2": "Analiza danych, Lean i optymalizacja procesów",
          "#services .col-md-4:nth-child(2) p": "Interesuje mnie wykorzystywanie podejścia data-driven do analizy i optymalizacji procesów, ze szczególnym uwzględnieniem Lean, Six Sigma i pokrewnych metod doskonalenia.",
          "#services .col-md-4:nth-child(3) h2": "Modelowanie symulacyjne i metody numeryczne",
          "#services .col-md-4:nth-child(3) p": "Skupiam się na praktycznych zastosowaniach modelowania symulacyjnego, optymalizacji, metod numerycznych i modeli matematycznych w rozwiązywaniu rzeczywistych problemów.",
          "#services .col-md-4:nth-child(4) h2": "Automatyzacja procesów i AI",
          "#services .col-md-4:nth-child(4) p": "Automatyzuję procesy i wykorzystuję AI tam, gdzie realnie zwiększa efektywność, porządkuje operacje i wspiera trafniejsze decyzje.",
          "#services .col-md-4:nth-child(5) h2": "Cyberbezpieczeństwo",
          "#services .col-md-4:nth-child(5) p": "Cyberbezpieczeństwo traktuję jako ważny element nowoczesnych systemów. Rozwijam się w obszarze bezpieczeństwa sieci, OSINT-u i etycznego hackingu, aby lepiej rozumieć zagrożenia i sposoby ich ograniczania.",
          "#services .col-md-4:nth-child(6) h2": "Matematyka i algebra procesów",
          "#services .col-md-4:nth-child(6) p": "Interesują mnie struktury matematyczne, algebra procesów, teoria grafów, optymalizacja i modele abstrakcyjne, które pomagają opisywać, analizować i usprawniać złożone systemy.",
          ...
          ".knowledge-tab > .knowledge-tab-text:last-of-type": "<strong>KnowledgeCenter już dziś ogranicza ponad 3 000 roboczogodzin rocznie w porównaniu z wcześniejszym sposobem realizacji tych samych procesów operacyjnych.</strong> <strong>Szacunek wynika z redukcji czasów procesowych w już wdrożonych workflowach.</strong> <strong>Poza skróceniem czasu realizacji bieżących działań umożliwia także zadania, które wcześniej były zbyt czasochłonne, by wykonywać je regularnie i konsekwentnie.</strong> <strong>Daje natychmiastowy dostęp do użytecznej wiedzy w wielu obszarach, gdzie wcześniej uzyskanie podobnej widoczności wymagało dużego nakładu czasu albo było praktycznie niemożliwe.</strong> <strong>To działający zasób organizacyjny, który generuje wartość i oszczędności także wtedy, gdy nie uczestniczę bezpośrednio w pracy operacyjnej.</strong>"
        },
        attrs: [
          { selector: "html", attr: "lang", value: "pl" },
          { selector: ".language-switcher", attr: "aria-label", value: "Przełącznik języka" },
