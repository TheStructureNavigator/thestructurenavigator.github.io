    ...
    en: {
      ...
      portfolio: {
        ...
        texts: {
          ...
          ".knowledge-tab-two-col:nth-of-type(1) .knowledge-tab-col:nth-child(1) .knowledge-tab-subtitle": "Objectives",
          ...
          ".knowledge-tab-two-col:nth-of-type(1) .knowledge-tab-col:nth-child(2) .knowledge-tab-subtitle": "Philosophy",
    ...
    pl: {
      ...
      portfolio: {
        ...
        texts: {
          ...
          "#portfolio .section-title p": "To portfolio jest odzwierciedleniem mojej drogi przez różne projekty. Każdy z nich nauczył mnie czegoś nowego i pozwolił mi się rozwijać — zarówno pod względem umiejętności, jak i sposobu rozumienia problemów.",
          ...
          ".realestate-lead": "TWÓRCA I ARCHITEKT PLATFORMY WWW DLA SIECI FRANCZYZOWEJ BIUR NIERUCHOMOŚCI ORAZ SYSTEMU CRM WSPIERAJĄCEGO SPRZEDAŻ I OBSŁUGĘ OFERT",
          ...
          ".knowledge-tab-two-col:nth-of-type(1) .knowledge-tab-col:nth-child(1) .knowledge-tab-subtitle": "Cele",
          ...
          ".knowledge-tab-two-col:nth-of-type(1) .knowledge-tab-col:nth-child(2) .knowledge-tab-subtitle": "Filozofia",
